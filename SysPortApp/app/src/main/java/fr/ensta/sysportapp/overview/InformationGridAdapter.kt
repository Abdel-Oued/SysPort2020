 ...
 */
class InformationGridAdapter(val onClickListener: OnClickListener) : ListAdapter<PersonInformation, InformationGridAdapter.PersonInformationViewHolder>(DiffCallback) {
